...
?>
    ...
    <body style="background-image: linear-gradient(rgba(0, 0, 0, 0.4), rgba(0, 0, 0, 0.8)), url(../images/first_page.jpg);
    height: 100vh;
            ...
            <div class="login-content animated fadeIn" style="animation-duration: 1s">
                ...
                <div class="login-form">
                    <form name="form1" action="" method="post">
                        ...
                        <button name="register" class="btn btn-success btn-flat m-b-30 m-t-30" style="margin-top: 10px;"
                                onclick="document.location = 'register.php'"> Реєстрація </button>
